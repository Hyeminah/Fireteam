...
export class PlayerFireteamController {
  ...
  @Post("register")
  async createPlayerFireteam(
    @Body() createPlayerFireteamDto: CreatePlayerFireteamDto,
  ): Promise<PlayerFireteam> {
    return this.playerFireteamService.createPlayerFireteam(
      createPlayerFireteamDto,
    );
  }
}
